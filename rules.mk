...
$(UF2): $(FL_OBJS) $(BINARY)
	...
	python uf2/utils/uf2conv.py -c -f 0x2fca8c7e -b 0x08010000 $(BUILD_DIR)/flasher.bin -o $(BUILD_DIR)/flasher.uf2
	...
	python uf2/utils/uf2conv.py -c -f 0x2fca8c7e -b 0x08008000 $(BUILD_DIR)/flasher16.bin -o $(BUILD_DIR)/flasher16.uf2
